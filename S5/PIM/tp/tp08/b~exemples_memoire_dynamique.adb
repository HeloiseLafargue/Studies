pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~exemples_memoire_dynamique.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~exemples_memoire_dynamique.adb");
