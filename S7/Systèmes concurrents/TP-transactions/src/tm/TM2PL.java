...
// Mémoire transactionnelle avec contrôle de concurrence minimal : 
// verrouillage bloquant à deux phases strict.
public class TM2PL extends AbstractTM {  
        ...
        public TM2PL(Map<String,Integer> t_objects,
