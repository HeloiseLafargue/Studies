...
public class MaxTabThread {
    ...
    private static int computeMax(int[] array, int numberOfThreads) throws InterruptedException {
        ...
        // Le traitement du tableau est décomposé en segment de taille taskSize : [0..taskSize[, [taskSize..2*taskSize[ etc
        ...
        for (int i=0; i <= numberOfThreads; i++) {
            PartialMax segment = new PartialMax(array, i*taskSize, Math.min((i+1)*taskSize, array.length), results);
