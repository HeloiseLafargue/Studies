...
/* A FAIRE : Completer pour ajouter les autres formes d'instructions */
               instruction : expression PTVIRG { (print_endline "instruction : expression PTVIRG") }
			   				 | SI PAROUV expression PARFER bloc elsebloc
							 | TANTQUE PAROUV expression PARFER bloc
                             | RETOUR expression PTVIRG  { (print_endline "instruction : RETURN expression PTVIRG") }

				elsebloc : SINON bloc | { (print_endline "instruction : rien") }
				
/* A FAIRE : Completer pour ajouter les autres formes d'expressions */
expression : unaires bloc2 | binaires {}

unaires : unaire unaires | { (print_endline "mot vide") }
unaire : PAROUV typee PARFER
		 | OPPLUS
		 | OPMOINS
		 | OPNONEG {}

binaires : binaire binaires | { (print_endline "mot vide") }
binaire : ASSIGN | OPPT | OPPLUS | OPMOINS | OPMULT | OPDIV | OPMOD | OPOU | OPET | OPNONEG {}

bloc2 : ENTIER | FLOTTANT | CARACTERE | BOOLEEN | VIDE | NOUVEAU IDENT bloc3 | bloc4 suffixes {}
bloc3 : PAROUV PARFER | CROOUV expression CROFER {}
bloc4 : IDENT | PAROUV expression PARFER {}

suffixes : suffixe suffixes | { (print_endline "mot vide") }
suffixe : PAROUV blocSuffixe PARFER | CROOUV expression CROFER {}
blocSuffixe : expression blocSuffixe2 | { (print_endline "mot vide") }
blocSuffixe2 : VIRG expression blocSuffixe2 {}


typee : blocType1 blocType2 {}
blocType1 : INT | FLOAT | BOOL | CHAR | STRING | IDENT {}
blocType2 : CROOUV CROFER | { (print_endline "mot vide") }
%%
