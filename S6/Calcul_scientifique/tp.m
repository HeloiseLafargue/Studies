...
figure('Position',[0.1*L,0.1*H,0.8*L,0.75*H])
    ...
    leg = legend('Gram-Schmidt classique',...
                 'Gram-Schmidt classique itéré 2 fois',...
                 'Gram-Schmidt modifie',...
                 'Gram-Schmidt modifie itéré 2 fois',...
                 'Location','NorthWest');
    set(leg,'FontSize',14);
    xlim([x(1) x(end)])
