...
for i = 1:length(r)
    for j = 1:length(v)
        X = [r,v];
        vraisemblance_chrysanthemes = vraisemblance(r,v,mu_chrysanthemes,Sigma_chrysanthemes,denominateur_classe_chrysanthemes);
        vraisemblance_pensees = vraisemblance(r,v,mu_pensees,Sigma_pensees,denominateur_classe_pensees);
        vraisemblance_oeillets = vraisemblance(r,v,mu_oeillets,Sigma_oeillets,denominateur_classe_oeillets);
    end
end
